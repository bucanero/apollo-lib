...
// NFS Undercover
const char NFS_XOR_KEY[] = {0x21, 0xF3, 0xC6, 0xD2, 0x08, 0x63, 0xAA, 0xAC, 0x38, 0xE2, 0x20, 0x62, 0x0D, 0x0D, 0x4D, 0x52};

// Metal Gear Solid 2/3 HD
#define MGS2_KEY        "2MetalOfSolidSonsLibertyGear"
#define MGS3_KEY        "3MetalSolidSnakeEaterGear"
const char MGS2_ALPHABET[] = "ghijklmn01234567opqrstuvEFGHIJKL89abcdefUVWXYZ_.wxyzABCDMNOPQRST";
const char MGS3_ALPHABET[] = "ghijklmn01234567opqrstuvEFGHIJKL89abcdefUVWXYZ+-wxyzABCDMNOPQRST";
...
const char BL3_PROFILE_PREFIX_PS4[] = {
...
const char BL3_PROFILE_XOR_PS4[] = {
...
const char BL3_DATA_PREFIX_PS4[] = {
